...
def draw_descriptions():
    ...
    for i in range(0, 7):
        # Die x Koordinate berechnen mit dem Kosinus, multipliziert mit der Distanz zum Fenstermittelpunkt 
        x = window_size/2 + (cos(math.radians(angle*i - 90))*distance)
        # Die y Koordinate berechnen mit dem Sinus, multipliziert mit der Distanz zum Fenstermittelpunkt 
...
def draw_ruler():
    ...
    # Wir zeichnen den Punkt des rulers am korrekten Ort zum Prozess Winkel.
    # Um die richtigen Koordinaten zu erhalten, müssen wir von unserem Winkel jeweils 90 Grad subtrahieren. Dies stammt daher, dass der Einheitskreis bei für uns 90 Grad beginnt. 
    ...
    if H < circle_diamater/2 + 100 and H > circle_diamater/2 - 100 and mousePressed == True:
        ...
        if mouseY < window_size/2:
            ...
            if mouseX > window_size/2:
                ...
                ## print(-math.degrees(math.acos((mouseX-window_size/2)/H))+90)
            ...
            # Hier müssen wir 450 Grad minus den Winkel des Arkuskosinus rechnen.
                ...
                ## print(360-math.degrees(math.acos((mouseX-window_size/2)/H))+90)
